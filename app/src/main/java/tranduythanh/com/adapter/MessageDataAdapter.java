...
public class MessageDataAdapter extends RecyclerView.Adapter {
    ...
    //This class is used to display the interface and data asked by the user OpenAI
    ...
    //This class is used to display the interface and data when receiving the results returned from OpenAI
